...
public class updatePicture extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet updatePicture</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet updatePicture at " + request.getContextPath() + "</h1>");
            ...
            try {
                ...
                String dbpath = "./images/uploads/profilePictures/" + fileName;
                // Specify the directory where the uploaded image will be saved
                String uploadDirectory = "C:\\Users\\HP\\Documents\\NetBeans_8.2\\TrendHIRE\\web\\images\\uploads\\profilePictures";
                ...
                String query;
                query = "UPDATE seeker SET seekerImg =? WHERE seekerID = ?;";
                ...
                if (a > 0) {
                    ...
                    response.sendRedirect("userprofile.jsp?success=2");
