...
public class uploadcv extends HttpServlet {
    ...
    String dbpath = "./images/uploads/cvs/" + fileName;

    // Specify the directory where the uploaded PDF will be saved
    String uploadDirectory = "C:\\Users\\HP\\Documents\\NetBeans_8.2\\TrendHIRE\\web\\images\\uploads\\cvs";
    ...
    String query;
    query = "UPDATE seeker SET 	seekerCV = ? WHERE seekerID = ?;";
    ...
    if (a > 0) {
        response.sendRedirect("userprofile.jsp?success=1");
    }
