...
<html>
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 mx-auto">	
                        <form action="./backend/seekerLoginProcess.jsp" method="post">
                            <h3 class="text-center">LOGIN AS JOB SEEKER</h3>
                            <a href="companyLogin.jsp"  <P style="color: red">Login as Company?</P> </a>
        ...
        <a href="adminLogin.jsp"  <P style="color: red">Login as Admin?</P> </a>
        <footer id="footer">
