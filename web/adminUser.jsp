                ...
                <div class="row">
                    <div class="col-sm-3 pe-lg-5">
                        ...
                        <div class="proLinks">
                            ...
                            <div class="d-grid mb-4">
                                <a href="adminUser.jsp" class="btn btn-danger">
                                    ...
                                    <div class="card">
                                        ...
                                        <%
                                            ...
                                            try {
                                                ...
                                                String countQuery = "SELECT COUNT(*) AS total FROM seeker";
                                                ...
                                                String query = "SELECT * FROM seeker LIMIT ?, ?";
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody class="customtable">
                                                    <%  while (resultSet.next()) {
                                                            ...
                                                            String userId = resultSet.getString("seekerID");
                                                            String name = resultSet.getString("seekerFName");
                                                            String lname = resultSet.getString("seekerLName");
                                                            String username = resultSet.getString("seekerUName");
                                                            String email = resultSet.getString("seekerEmail");
                                                            String phoneNumber = resultSet.getString("seekerPhone");
                                                            String modalId = "profilModal" + userId;

                                                            out.println("<tr>");
                                                            out.println("<td>U00" + userId + "</td>");
                                                            out.println("<td>" + name + " " + lname + "</td>");
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <label for="formFile" class="form-label fs-5">Are you sure to delete this user?  </label>
