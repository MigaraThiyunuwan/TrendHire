                ...
                <div class="row">
                    <div class="col-sm-3 pe-lg-5">
                        ...
                        <div class="proLinks">
                            ...
                            <div class="d-grid mb-4">
                                <a href="adminPost.jsp" class="btn btn-danger">
                                    ...
                                    <div class="card">
                                        ...
                                        <%
                                            ...
                                            try {
                                                ...
                                                String query = "SELECT * FROM vacancy LIMIT ?, ?";
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody class="customtable">
                                                    <%  while (resultSet.next()) {
                                                            ...
                                                            String query1;
                                                            query1 = "SELECT companyName FROM company WHERE companyID  = ?;";
                                                            try {
                                                                ...
                                                                if (resultSet1.next()) {
                                                                    ...
                                                                    out.println("<tr>");
                                                                    out.println("<td>P00" + vacancyID + "</td>");
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <input type="hidden" name="adminDeleteVacancy" value="<% out.print(vacancyID); %>">
